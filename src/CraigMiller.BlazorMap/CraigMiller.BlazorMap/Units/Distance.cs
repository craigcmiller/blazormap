...
namespace CraigMiller.BlazorMap.Units
{
    ...
    {
        private const double MetreInNauticalMiles = 0.000539957;
        private const double MetreInStatuteMiles = 0.000621371;
        private const double MetreInKilometres = 0.0001;
        private const double MetreInFeet = 3.28084;
